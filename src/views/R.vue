...
.controls-container .btn--green:hover {
...
v-for="(palabra, index) in palabras" :key="index" :style="estilo1"
@click="seleccionado(palabra, index)" :class="palabra.estilo" >
{{ palabra.letra }}
{{ palabra.descripcion }}
